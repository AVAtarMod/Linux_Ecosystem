// generated by /usr/local/bin/sqlpp11-ddl2cpp architecture/first-level/tool-CM/TCM.db-script.sql code/tool-CM/orm tool_cm
#ifndef TOOL_CM_ORM_H
#define TOOL_CM_ORM_H
...
namespace tool_cm
{
               ...
               ComponentStatus_::Status>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "Componentstatus";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
               ...
               ComponentDependency_::IsStrict>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "Componentdependency";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
               ...
               ComponentEndpoint_::ComponentId>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "Componentendpoint";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
