...
(
 ...
 CONSTRAINT PRIMARY KEY ( hardware_id ),
 CONSTRAINT FOREIGN KEY ( hardware_id ) REFERENCES HardwareItem ( hardware_id )
);
...
(
 ...
 CONSTRAINT PRIMARY KEY ( hardware_info_id )
);
...
(
 ...
 CONSTRAINT PRIMARY KEY ( hardware_id ),
 CONSTRAINT FOREIGN KEY ( class_id ) REFERENCES HardwareItemClass ( class_id ),
 CONSTRAINT FOREIGN KEY ( hardware_info_id ) REFERENCES HardwareInfo ( hardware_info_id ),
 CONSTRAINT FOREIGN KEY ( product_id ) REFERENCES Product ( product_id )
);
